...
while True:
    ...
    if not letter5:
        ...
        if letter4 not in norm_prob[letter1][letter2][letter3]:
            norm_prob[letter1][letter2][letter3][letter4] = 0
        norm_prob[letter1][letter2][letter3][letter4] += 1
        ...
        if letter5 not in cond_prob[letter1][letter2][letter3][letter4]:
            cond_prob[letter1][letter2][letter3][letter4][letter5] = 0
        cond_prob[letter1][letter2][letter3][letter4][letter5] +=1
    ...
    for letter2 in norm_prob[letter1]:
        for letter3 in norm_prob[letter1][letter2]:
            for letter4 in norm_prob[letter1][letter2][letter3]:
                norm_prob[letter1][letter2][letter3][letter4]= norm_prob[letter1][letter2][letter3][letter4] / (summ-3)
        ...
        for letter3 in cond_prob[letter][letter2]:
            for letter4 in cond_prob[letter][letter2][letter3]:
                for letter5 in cond_prob[letter][letter2][letter3][letter4]:
                    cond_prob[letter][letter2][letter3][letter4][letter5] = cond_prob[letter][letter2][letter3][letter4][letter5] / (summ-4)
        ...
        for letter3 in cond_prob[letter1][letter2]:
            for letter4 in cond_prob[letter1][letter2][letter3]:
                for letter5 in cond_prob[letter1][letter2][letter3][letter4]:
                    cond_prob[letter1][letter2][letter3][letter4][letter5] = cond_prob[letter1][letter2][letter3][letter4][letter5] / norm_prob[letter1][letter2][letter3][letter4]
...
for i in range(50):
    next_letter = random.choices(list(cond_prob[first_letter][second_letter][third_letter][fourth_letter].keys()), weights=list(cond_prob[first_letter][second_letter][third_letter][fourth_letter].values()), k=1)[0]
    sample += next_letter
    first_letter = second_letter
    second_letter = third_letter
    third_letter = fourth_letter
    fourth_letter = next_letter
print("Fourth order :", sample.replace("space", " "))